 ...
 *   - source 由 statements 重新序列化生成；行号自动重排
 *
 * 当前提供的算子：
...
import { geometryFromStatements, list, num } from './make.js';
...
export function withPartPose(
  ...
  return geometryFromStatements(newStatements, { previous: geom, focus: geom.focus });
}
