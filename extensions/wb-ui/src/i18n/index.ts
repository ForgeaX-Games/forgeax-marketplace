...
import type { WorkflowStepId } from '../pipelines/ui-design/model';

export function workflowSteps(): Array<{ id: WorkflowStepId; label: string }> {
  return [
    { id: 'genre', label: t('step.genre') },
    { id: 'layout', label: t('step.layout') },
    { id: 'style', label: t('step.style') },
    { id: 'component-preview', label: t('step.component-preview') },
    { id: 'prototype', label: t('step.prototype') },
  ];
}
