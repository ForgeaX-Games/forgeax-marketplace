...
export default defineAtomic({
  "functionName": "opensimplex2Noise",
  "contractVersion": "1.0.0",
  "opId": "opensimplex2_noise",
  "description": "OpenSimplex2 noise generator based on FastNoiseLite, producing artifact-free gradient noise with fractal support.",
  "inputs": [
    {
      "name": "width",
      "type": "number",
