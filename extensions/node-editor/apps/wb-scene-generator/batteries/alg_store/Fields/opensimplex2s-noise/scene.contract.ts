...
export default defineAtomic({
  "functionName": "opensimplex2sNoise",
  "contractVersion": "1.0.0",
  "opId": "opensimplex2s_noise",
  "description": "OpenSimplex2S noise generator based on FastNoiseLite, a smoother variant of OpenSimplex2 with higher quality, supporting fractal types.",
  "inputs": [
    {
      "name": "width",
      "type": "number",
