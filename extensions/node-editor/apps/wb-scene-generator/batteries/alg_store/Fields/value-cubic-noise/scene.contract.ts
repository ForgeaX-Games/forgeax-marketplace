...
export default defineAtomic({
  "functionName": "valueCubicNoise",
  "contractVersion": "1.0.0",
  "opId": "value_cubic_noise",
  "description": "Value Cubic noise generator based on FastNoiseLite, using cubic-interpolated lattice random values for smoother output than basic Value noise, with fractal support.",
  "inputs": [
    {
      "name": "width",
      "type": "number",
