...
describe('billboard asset mode', () => {
  it('mounts in asset drawMode without throwing (images async/absent in jsdom)', () => {
    useRenderStore.getState().setViewMode('topBillboard')
