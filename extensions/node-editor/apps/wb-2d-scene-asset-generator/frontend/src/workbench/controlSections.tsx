// Shared collapsible section chrome for left-pane control stacks (Asset Graph,
// Asset Folders, Image Preview). Styled by `.scene-left-pane .editor-controls__*`
// in WorkbenchLeftPane.css.
