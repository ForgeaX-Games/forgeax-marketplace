...
import retroFutureRaw from '../skills/film-looks/retro-future/SKILL.md?raw'
import baroqueRaw from '../skills/film-looks/baroque-chiaroscuro/SKILL.md?raw'
import tealOrangeRaw from '../skills/film-looks/teal-orange/SKILL.md?raw'
import bleachBypassRaw from '../skills/film-looks/bleach-bypass/SKILL.md?raw'
import pastelRaw from '../skills/film-looks/pastel-symmetry/SKILL.md?raw'
import noirRaw from '../skills/film-looks/noir-lowkey/SKILL.md?raw'
import warmNostalgiaRaw from '../skills/film-looks/warm-nostalgia/SKILL.md?raw'
import clinicalRaw from '../skills/film-looks/clinical-scifi/SKILL.md?raw'
import morandiRaw from '../skills/film-looks/morandi-muted/SKILL.md?raw'
import bronzeRaw from '../skills/film-looks/bronze-epic/SKILL.md?raw'
