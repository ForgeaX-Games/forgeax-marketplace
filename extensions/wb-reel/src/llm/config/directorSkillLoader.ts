...
import principleRaw from '../skills/directors/_shared/directing-principle.md?raw'
import minimalEpicRaw from '../skills/directors/minimal-epic/SKILL.md?raw'
import precisionNoirRaw from '../skills/directors/precision-noir/SKILL.md?raw'
import foreknowledgeSuspenseRaw from '../skills/directors/foreknowledge-suspense/SKILL.md?raw'
import moodNeonRaw from '../skills/directors/mood-neon/SKILL.md?raw'
import luminousAnimeRaw from '../skills/directors/luminous-anime/SKILL.md?raw'
import kineticClarityRaw from '../skills/directors/kinetic-clarity/SKILL.md?raw'
import cyberpunkRaw from '../skills/directors/cyberpunk-neonoir/SKILL.md?raw'
import unseenHorrorRaw from '../skills/directors/unseen-horror/SKILL.md?raw'
import nonlinearScifiRaw from '../skills/directors/nonlinear-scifi/SKILL.md?raw'
import pulpDialogueRaw from '../skills/directors/pulp-dialogue/SKILL.md?raw'
